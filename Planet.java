...
/**
 * Esta clase permite la instanciación de objetos de tipo Planeta, que hereda
 * los atributos del sistema planetario y un método obstracto.
 *
 ...
 *
 */
public class Planet extends Planetary_system {

    /**
     * Contructor de la clase para la instanciación de objetos de tipo Planeta
     ...
     * @param distanceFromTheSun Distancia al sol del cuerpo celeste.
     * @param ID Identificación del cuerpo celeste.
     * @param name Nombre del cuerpo celeste.
     */
    public Planet(double mass, double density, double diameter, double distanceFromTheSun, int ID, String name) {
        super(mass, density, diameter, distanceFromTheSun, ID, name);
    }

    /**
     * Constructor de objetos tipo planeta sin atributos.
     */
    public Planet() {
    }
     ...
     * abstracto que hereda a la clase Planeta de Planetary_system o sistema
     * planetario.
     *
